...
return [
  ...
  'nextDisabled' => '<li class="page-item next disabled"><a class="page-link" href="" tabindex="-1" onclick="return false;">{{text}}</a></li>',
  'prevActive' => '<li class="page-item prev"><a class="page-link" rel="prev" href="{{url}}">{{text}}</a></li>',
  'prevDisabled' => '<li class="page-item prev disabled"><a class="page-link" href="" tabindex="-1" onclick="return false;">{{text}}</a></li>',
