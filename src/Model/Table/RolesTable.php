 ...
 * @property \App\Model\Table\ModulesPermissionsTable&\Cake\ORM\Association\BelongsToMany $ModulesPermissions
 *
...
class RolesTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsToMany('ModulesPermissions', [
            'foreignKey' => 'role_id',
            'targetForeignKey' => 'modules_permission_id',
