...
<body>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?= ($controller == 'Teachers' || $controller == 'Teachers') ? 'active' : ''?>">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOne"
                    aria-expanded="true" aria-controls="collapseOne">
                    <i class="fas fa-fw fa-chalkboard"></i>
                    <span><?= __('Subjects') ?></span>
                </a>
                <div id="collapseOne" class="collapse <?= ($controller == 'Pages' || $controller == 'Teachers') ? 'show' : ''?>" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header"><?= __('School Courses') ?></h6>
                        <?= $this->Html->link(__('My Academies'), ['controller' => 'Teachers', 'action' => 'myAcademies'], ['class' => 'collapse-item' . ($controller == 'Teachers' ? ' active' : '')]) ?>
                    </div>
                </div>
            </li>
