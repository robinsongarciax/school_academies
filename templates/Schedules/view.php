                ...
                <div class="table-responsive">
                    <table>
                        <tr>
                            ...
                            <th><?= __('Min Year Of Birth') ?></th>
                            <th><?= __('Max Year Of Birth') ?></th>
                            <th><?= __('Teacher Id') ?></th>
                            <th><?= __('Term Id') ?></th>
                            <th><?= __('Sex') ?></th>
                        ...
                        <tr>
                            ...
                            <td><?= h($schoolCourses->occupancy) ?></td>
                            <td><?= h($schoolCourses->criterio_academia) ?></td>
                            <td><?= h($schoolCourses->min_year_of_birth) ?></td>
                            <td><?= h($schoolCourses->max_year_of_birth) ?></td>
                            <td><?= h($schoolCourses->teacher_id) ?></td>
                            <td><?= h($schoolCourses->term_id) ?></td>
                            <td><?= h($schoolCourses->sex) ?></td>
                            <td><?= h($schoolCourses->tipo_academia) ?></td>
                            <td><?= h($schoolCourses->pago_obligatorio) ?></td>
                            <td><?= h($schoolCourses->visible) ?></td>
                            <td class="actions">
